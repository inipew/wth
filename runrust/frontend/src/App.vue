<template>
  <div>
    ...
    <div class="output-container">
      <pre id="output" aria-live="polite" v-if="output">{{ output }}</pre>
      <pre id="error" aria-live="polite" v-if="error" style="color: red">
        {{ error }}
        <br>
        {{ details }}
      </pre>
